...
category_index = label_map_util.create_category_index_from_labelmap('annotations/character-recog/label_map.pbtxt')
configs = config_util.get_configs_from_pipeline_file('models/efficientnetB0/character.config')
detection_model = model_builder.build(model_config=configs['model'], is_training=False)
...
ckpt.restore('models/efficientnetB0/character-recog/mdta/ckpt-12').expect_partial()#TX
